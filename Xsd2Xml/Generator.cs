...
//            int step = 1;
            int step = (new Random( (int) DateTime.Now.Ticks & 0xFFFF)).Next(100);
...
//            protected decimal startValue = 1;
            protected decimal startValue = (decimal)(new Random( (int) DateTime.Now.Ticks & 0xFFFF)).NextDouble();
         ...
         internal class Generator_integer : Generator_decimal {
            ...
            public Generator_integer(CompiledFacets rFacets) : base(rFacets) {
                startValue = (decimal)(new Random( (int) DateTime.Now.Ticks & 0xFFFF)).Next(100);
                step = 1;
            }
        ...
        internal class Generator_nonPositiveInteger : Generator_integer {
            ...
            public Generator_nonPositiveInteger(CompiledFacets rFacets) {
                startValue = -(new Random((int)DateTime.Now.Ticks & 0xFFFF)).Next(100);
//                startValue = 0;
                increment = 1;
                maxBound = 0;
                CheckFacets(rFacets);
        ...
        internal class Generator_negativeInteger : Generator_nonPositiveInteger {
            public Generator_negativeInteger(CompiledFacets rFacets) {
                startValue = -(new Random((int)DateTime.Now.Ticks & 0xFFFF)).Next(100) - 1;
//                startValue = -1;
                maxBound = -1;
                CheckFacets(rFacets);
            }
...
//                startValue = 1;
        ...
        internal class Generator_boolean : XmlValueGenerator {
            public override string GenerateValue() {
                ...
                int n = (new Random((int)DateTime.Now.Ticks & 0xFFFF)).Next(2);
                bool b = (n == 1);
